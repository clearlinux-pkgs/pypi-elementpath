...
Version  : 3.0.1
Release  : 21
URL      : https://files.pythonhosted.org/packages/62/07/04a4b77c0cf8d5cbcb9d5e6e6aa0ca8ed681f489f7bce610c2d32337192f/elementpath-3.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/62/07/04a4b77c0cf8d5cbcb9d5e6e6aa0ca8ed681f489f7bce610c2d32337192f/elementpath-3.0.1.tar.gz
...
%prep
%setup -q -n elementpath-3.0.1
cd %{_builddir}/elementpath-3.0.1
pushd ..
cp -a elementpath-3.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658764059
