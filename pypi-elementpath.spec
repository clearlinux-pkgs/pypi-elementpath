...
Version  : 2.5.2
Release  : 15
URL      : https://files.pythonhosted.org/packages/11/b3/eaa6824b18f1dd1219232b2a6eac070c9dcc691e1362cf56438a634813db/elementpath-2.5.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/11/b3/eaa6824b18f1dd1219232b2a6eac070c9dcc691e1362cf56438a634813db/elementpath-2.5.2.tar.gz
...
%prep
%setup -q -n elementpath-2.5.2
cd %{_builddir}/elementpath-2.5.2
pushd ..
cp -a elementpath-2.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653059349
...
cp %{_builddir}/elementpath-2.5.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-elementpath/9f7ea40a3b281ff78d11325e80eb8bcc5b49aa90
