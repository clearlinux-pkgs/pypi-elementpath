...
Version  : 3.0.0
Release  : 19
URL      : https://files.pythonhosted.org/packages/00/af/8fc920613e4fb35a3f125bf0bd580c69beb61178975358e8653aed47e809/elementpath-3.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/00/af/8fc920613e4fb35a3f125bf0bd580c69beb61178975358e8653aed47e809/elementpath-3.0.0.tar.gz
...
%prep
%setup -q -n elementpath-3.0.0
cd %{_builddir}/elementpath-3.0.0
pushd ..
cp -a elementpath-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658094379
...
cp %{_builddir}/elementpath-3.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-elementpath/9f7ea40a3b281ff78d11325e80eb8bcc5b49aa90
