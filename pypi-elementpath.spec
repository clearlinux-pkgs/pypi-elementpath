...
%prep
%setup -q -n elementpath-2.5.0
cd %{_builddir}/elementpath-2.5.0
...
cp %{_builddir}/elementpath-2.5.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-elementpath/9f7ea40a3b281ff78d11325e80eb8bcc5b49aa90
