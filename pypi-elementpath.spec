...
Version  : 3.0.2
Release  : 23
URL      : https://files.pythonhosted.org/packages/11/bc/5afb61dd5d863e5cf77cd952445c50c17e65953405986f19e97e4389692a/elementpath-3.0.2.tar.gz
...
%prep
%setup -q -n elementpath-3.0.2
cd %{_builddir}/elementpath-3.0.2
pushd ..
cp -a elementpath-3.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660335124
