...
Source0  : https://files.pythonhosted.org/packages/67/1d/f4f84b97785e32b1ae211e557059fa39a4f944c2afb9be3d75a8bb168bef/elementpath-4.0.1.tar.gz
...
%prep
%setup -q -n elementpath-4.0.1
cd %{_builddir}/elementpath-4.0.1
pushd ..
cp -a elementpath-4.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675377197
