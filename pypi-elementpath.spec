...
Version  : 4.2.0
Release  : 39
URL      : https://files.pythonhosted.org/packages/ae/1f/28bb3a4c87ee5c914d4fc79e2f24146c9059911e0d1abd3860b4a9dae9fc/elementpath-4.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/ae/1f/28bb3a4c87ee5c914d4fc79e2f24146c9059911e0d1abd3860b4a9dae9fc/elementpath-4.2.0.tar.gz
...
%prep
%setup -q -n elementpath-4.2.0
cd %{_builddir}/elementpath-4.2.0
pushd ..
cp -a elementpath-4.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707147842
